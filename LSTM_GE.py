...
ge_ser_tot_arr = ge_ser_tot.values
nrdata_tot = len(ge_ser_tot)

ge_ser_oot_arr = ge_ser_oot.values
nrdata_oot = len(ge_ser_oot)

ge_ser_arr = ge_ser.values
nrdata_train = len(ge_ser)

#Scale the data and make sure there is no information leak
scaler = MinMaxScaler(feature_range=(0,1))
scaled_data_tot = scaler.fit_transform(ge_ser_tot_arr.reshape(-1,1))

scaler = MinMaxScaler(feature_range=(0,1))
scaled_data_test = scaler.fit_transform(ge_ser_oot_arr.reshape(-1,1))

scaler = MinMaxScaler(feature_range=(0,1))
scaled_data_training = scaler.fit_transform(ge_ser_arr.reshape(-1,1))
...
x_test = []
y_test = ge_ser_tot_arr.reshape(-1,1)[nrdata_train:, :]
